...
<details>
  <summary>html tag testing...</summary>
  <pre>
    function asdf() {
      console.log("make me <b>BOLD!</b>");
      console.log("make me the  <h1>HEADER!!!</h1>");
      console.log("make me <del>diff</del>...no, <ins>different!</ins>");
      console.log("just press <kbd>Alt</kbd> + <kbd>F4</kbd> to shut down this");
    }
  </pre>
</details>
